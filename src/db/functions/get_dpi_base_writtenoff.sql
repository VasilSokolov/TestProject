DROP FUNCTION IF EXISTS get_dpi_base_writtenoff(date, date, date);
create function get_dpi_base_writtenoff(date, date, date)
  returns TABLE(
    loanappid integer,
    loanproduct text,
...
BEGIN
  ...
  SELECT
    ...
    dl.internaldate::date AS r_internaldate,
