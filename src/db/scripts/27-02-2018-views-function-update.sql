...
create function get_defaulted_loanapps_base(date, date, date) returns TABLE(loanappid integer, loanproduct text, loanproductid integer, refnr text, firstname text, lastname text, score text, office text, incassocompany text, incassocompanyid integer, loanamount numeric, loanperiod integer, activedate date, defaulteddate date, internaldate date, collectiondate date, writtenoffdate date, totaldebt numeric, principal numeric, restructured numeric, commissionfee numeric, interest numeric, guaranteefee numeric, adminfee numeric, firstrem numeric, secondrem numeric, termalertfee numeric, termfee numeric, firstremsms numeric, secondremsms numeric, thirdremsms numeric, fourthremsms numeric, fifthremsms numeric, suspensionfee numeric, delayinterest numeric, repaymentslater numeric, agreementsignment text, payoutto text)
AS $BODY$
BEGIN
...
create function get_defaulted_loanapps_bytermdate(date, date, date) returns TABLE(loanappid integer, loanproduct text, loanproductid integer, refnr text, firstname text, lastname text, score text, office text, incassocompany text, incassocompanyid integer, loanamount numeric, loanperiod integer, activedate date, defaulteddate date, collectiondate date, totaldebt numeric, principal numeric, restructured numeric, commissionfee numeric, interest numeric, firstrem numeric, secondrem numeric, termalertfee numeric, termfee numeric, suspensionfee numeric, delayinterest numeric, repaymentslater numeric, guaranteefee numeric, adminfee numeric, agreementsignment text, payoutto text, firstremsms numeric, secondremsms numeric, thirdremsms numeric, fourthremsms numeric, fifthremsms numeric)
AS $BODY$
BEGIN
...
create function get_internal_collection_loanapps_base(date, date, date) returns TABLE(loanappid integer, loanproduct text, loanproductid integer, refnr text, firstname text, lastname text, defaultintrest double precision, score text, office text, incassocompany text, incassocompanyid integer, loanamount numeric, loanperiod integer, activedate date, defaulteddate date, collectiondate date, totaldebt numeric, principal numeric, restructured numeric, commissionfee numeric, guaranteefee numeric, adminfee numeric, interest numeric, firstrem numeric, secondrem numeric, termalertfee numeric, termfee numeric, firstremsms numeric, secondremsms numeric, thirdremsms numeric, fourthremsms numeric, fifthremsms numeric, suspensionfee numeric, delayinterest numeric, repaymentslater numeric, repaymentsbefore numeric, agreementsignment text, comments text, payoutto text)
AS $$
BEGIN
