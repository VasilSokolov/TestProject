...
('<p>Kredia juaj eshte aprovuar. Shuma e kredise [amount] lek, Kesti [payback] lek, Data e pageses [first_rp]. Dergo PO nese pranoni.</p>',
now(), 'Comfort SMS - 1 month accepted', 'alb', 'comfort_accepted_1month_sms', 'sms');

INSERT INTO doc_template (content, created, name, lang, type, template_type) VALUES 
('<p>Kredia juaj eshte aprovuar. Shuma e kredise [amount] lek, Kesti i pare [first_payback] lek deri me [first_rp] dhe Kesti i dyte [second_payback] lek deri me [second_rp]. Dergo PO nese pranoni.</p>',
